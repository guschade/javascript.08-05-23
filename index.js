function inserirAluno(total_aulas){
    var matricula = prompt('Digite a sua matricula...');
    var nome = prompt('Digite o seu nome...');
    var qtd_faltas = parseInt(prompt('Digite a quantidade de faltas...'));
    ...
    var percentual_faltas = qtd_faltas / total_aulas;
    ...
    novaLinha.insertCell(2).innerText = qtd_faltas;
